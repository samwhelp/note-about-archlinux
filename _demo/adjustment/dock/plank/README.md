...
net.launchpad.plank.dock.settings theme 'Default'
...
/usr/lib/plank/
/usr/lib/plank/docklets/
/usr/lib/plank/docklets/libdocklet-applications.so
/usr/lib/plank/docklets/libdocklet-battery.so
/usr/lib/plank/docklets/libdocklet-clippy.so
/usr/lib/plank/docklets/libdocklet-clock.so
/usr/lib/plank/docklets/libdocklet-cpumonitor.so
/usr/lib/plank/docklets/libdocklet-desktop.so
/usr/lib/plank/docklets/libdocklet-trash.so
/usr/share/
